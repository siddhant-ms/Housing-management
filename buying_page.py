...
# Function to update slider based on "Rent" or "Buy" selection
def show_slider():
    if looking_var.get() == "Rent":
        rent_range.config(from_=0, to=50000, resolution=1000, state='normal')
        ...
        budget_range.config(from_=0, to=100000000, resolution=1000000, state='normal')
...
# Function to show the appropriate secondary dropdown based on the location
...
# Function to toggle property amenities section
...
# Tiny button to toggle property amenities
...
# Frame for property amenities (initially hidden)
amenities_frame = tk.Frame(root, bg=background_color)

# Checkbuttons for amenities with grid layout
...
# Place the amenities frame after the search button
amenities_frame.grid_remove()  # Hide initially
